...
function creaNuevaDB(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (id,nombre,apellidos,telefono,categoria,foto,email,nota) VALUES (1,'Unidad Mazatlan 1','centro@farmaciasdesimilares.com','CLL. Leandro Valle','amigo','','Sin informacion')");
}
